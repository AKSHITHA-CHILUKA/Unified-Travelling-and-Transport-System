...
tk.Label(name_email_frame, text="Name:", bg="#f0f0f0", font=("Arial", 14)).grid(
    row=0, column=0, sticky="w", padx=10
)
name_entry = tk.Entry(name_email_frame, font=("Arial", 14))
name_entry.grid(row=0, column=1, padx=10)

tk.Label(name_email_frame, text="Email:", bg="#f0f0f0", font=("Arial", 14)).grid(
...
tk.Label(amount_method_frame, text="Amount (Rs):", bg="#f0f0f0", font=("Arial", 14)).grid(
    row=0, column=0, sticky="w", padx=10
)
...
payment_method_optionmenu = tk.OptionMenu(
    amount_method_frame, payment_method_var, "Credit Card", "Debit Card"
)
payment_method_optionmenu.config(font=("Arial", 14))
payment_method_optionmenu.grid(row=1, column=1, padx=10)

card_label = tk.Label(
    root, text="Card Details", font=("Arial", 16), bg="#f0f0f0", padx=20, pady=15
)
card_label.pack()
...
tk.Label(card_details_frame, text="CVV:", bg="#f0f0f0", font=("Arial", 14)).grid(
